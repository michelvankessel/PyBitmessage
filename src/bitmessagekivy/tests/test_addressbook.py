...
class AddressBook(TeleniumTestProcess):
    ...
    def test_save_address(self):
        ...
        self.assertCheckScrollDown(
            "//ContentNavigationDrawer//ScrollView[0]", timeout=5
        )
        ...
        self.assertExists(
            '//AddAddressPopup/BoxLayout[0]/MDTextField[@hint_text="Label"][@text=""]',
            timeout=5,
        )
        ...
        self.cli.setattr(
            '//AddAddressPopup/BoxLayout[0]/MDTextField[@hint_text="Label"]',
            "text",
            self.test_label,
        )
        # Checking the Label Field should not be empty
        self.assertExists(
            f'//AddAddressPopup/BoxLayout[0]/MDTextField[0][@text="{self.test_label}"]',
            timeout=5,
        )
        # Add Correct Address
        self.cli.setattr(
            '//AddAddressPopup/BoxLayout[0]/MDTextField[@hint_text="Address"]',
            "text",
        ...
        self.assertEqual(
            self.cli.getattr(
                "//AddAddressPopup/BoxLayout[0]/MDTextField[1][@text]", "text"
            ),
            test_address["autoresponder_address"],
        )
        ...
        self.assertExists(
            f'//AddAddressPopup/BoxLayout[0]/MDTextField[1][@text="{test_address["autoresponder_address"]}"]',
            timeout=5,
        )
    ...
    def test_dismiss_addressbook_popup(self):
        ...
        self.cli.setattr(
            "//AddAddressPopup/BoxLayout[0]/MDTextField[0]", "text", "test_label2"
        )
        # Checking the Label Field should not be empty
        self.assertExists(
            '//AddAddressPopup/BoxLayout[0]/MDTextField[0][@text="test_label2"]',
        ...
        self.cli.setattr(
            "//AddAddressPopup/BoxLayout[0]/MDTextField[1]",
            "text",
            test_address["recipient"],
        )
        # Checking the Address Field should not be empty
        self.assertExists(
            f'//AddAddressPopup/BoxLayout[0]/MDTextField[1][@text="{test_address["recipient"]}"]',
            timeout=5,
        )
    ...
    def test_send_message_to_saved_address(self):
        ...
        self.cli.wait_click(
            "//AddressBook/BoxLayout[0]//SwipeToDeleteItem[0]", timeout=5
        )
        ...
        self.assertExists(
            f'//DropDownWidget/ScrollView[0]//MyTextInput[@text="{test_address["autoresponder_address"]}"]',
            timeout=5,
        )
        # CLICK BACK-BUTTON
        self.cli.wait_click(
