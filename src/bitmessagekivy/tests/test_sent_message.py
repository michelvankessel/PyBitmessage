...
class SendMessage(TeleniumTestProcess):
    ...
    def test_validate_empty_form(self):
        ...
        self.assertExists(
            '//DropDownWidget/ScrollView[0]//MDTextField[@text=""]', timeout=5
        )
        ...
        self.assertExists(
            '//DropDownWidget/ScrollView[0]//MyMDTextField[@text=""]', timeout=5
        )
    ...
    def test_validate_half_filled_form(self):
        ...
        self.assertExists(
            f'//DropDownWidget/ScrollView[0]//MDTextField[@text="{sender_address}"]',
            timeout=5,
        )
        ...
        self.assertExists(
            '//DropDownWidget/ScrollView[0]//ScrollView[0]/MDTextField[@text=""]',
            timeout=5,
        )
        # ADD BODY
        self.cli.setattr(
            "//DropDownWidget/ScrollView[0]/BoxLayout[0]/ScrollView[0]/MDTextField[0]",
            "text",
            self.test_body,
        )
