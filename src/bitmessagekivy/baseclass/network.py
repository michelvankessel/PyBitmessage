...
class NetworkStat(Screen):
    ...
    text_variable_1 = StringProperty('Total Connections::0')
    text_variable_2 = StringProperty('Processed 0 peer-to-peer messages')
    text_variable_3 = StringProperty('Processed 0 broadcast messages')
    text_variable_4 = StringProperty('Processed 0 public keys')
    text_variable_5 = StringProperty('Processed 0 objects to be synced')
